...
- **Topic hierarchy and wildcards** with `factory/#` style routing.
- **QoS, retained messages, and LWT** demonstrations.
- **Access control and fault scenarios** with observable traffic.
- **Web dashboard** for device state, telemetry, and commands.

[**View on Github**](https://github.com/dylanjgoode/Virtual-Factory)
